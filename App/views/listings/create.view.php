  ...
  <section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-1/2 mx-6">
      ...
      <form method="POST">
        ...
        <a href="/" class="block text-center w-full px-4 py-2 border-2 border-brightRed hover:bg-brightRed text-brightRed hover:text-white rounded focus:outline-none">
          Cancel
        </a>
      </form>
    </div>

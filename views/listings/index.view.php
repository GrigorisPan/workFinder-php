...
<?php loadPartial('listings-banner'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div class="rounded-lg shadow-md bg-white">
        <div class="p-4">
          ...
          <a href="listings/create" class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-white bg-brightRedLight hover:bg-brightRed">
            Details
          </a>
        </div>
      </div>
